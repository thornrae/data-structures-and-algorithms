...
const toLastNames = people => {
  //assign map function to a new variable in order to return since map creates a new array the same length of the original array
...
const validatePin = (pin) => {
  let pinCheck = /^(\d{4})$/g;
  return pinCheck.test(pin);
};


//^ indicates a start $ indicates end
/* ------------------------------------------------------------------------------------------------
CHALLENGE 3
...
const validateEmail = (email) => {
  let emailRegex = /^\w+(|.)\w+@\w+\.(net|com|org)$/g;
  //^ start
  //any character one or more
  //with the option of that word include a .
  //one or more of the word
  //literal @ symbol
  //any character one or more
  //literal dot
  //alternation options of net, com or org
  //$ end
